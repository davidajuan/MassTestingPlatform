 ...
 */
class BusinessSearch implements ParsersInterface {
    /**
    ...
    public function encode(array &$response)
    {
        ...
        $this->safeInsert('business_code', $response, $encodedResponse);
        $this->safeInsert('status', $response, $encodedResponse);
        $this->safeInsert('slots_requested', $response, $encodedResponse);
        $this->safeInsert('slots_approved', $response, $encodedResponse);
        $this->safeInsert('request_created', $response, $encodedResponse);
        $this->safeInsert('total_slots_used', $response, $encodedResponse);
        $this->safeInsert('priority_service', $response, $encodedResponse);
